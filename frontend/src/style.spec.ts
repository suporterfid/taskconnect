...
const legacyAllowlist: Record<string, Record<string, number>> = {
  'src/components/LoadingState.vue': { 'border-violet-600': 1 },
  'src/components/PageHeader.vue': { 'text-gray-100': 1, 'text-gray-400': 1, 'text-gray-600': 1, 'text-gray-900': 1 },
  'src/layouts/AppLayout.vue': { 'bg-gray-100': 2, 'bg-gray-50': 1, 'bg-gray-800': 5, 'bg-gray-900': 2, 'bg-gray-950': 1, 'bg-violet-50': 1, 'bg-violet-950': 1, 'border-gray-200': 4, 'border-gray-300': 3, 'border-gray-700': 3, 'border-gray-800': 4, 'text-gray-300': 2, 'text-gray-500': 4, 'text-gray-700': 2, 'text-violet-300': 1, 'text-violet-600': 1, 'text-violet-700': 1 },
  'src/pages/ApiKeysPage.vue': { 'bg-gray-100': 1, 'bg-gray-50': 2, 'bg-gray-800': 1, 'bg-gray-900': 2, 'bg-gray-950': 2, 'bg-violet-600': 3, 'bg-violet-700': 3, 'border-gray-200': 3, 'border-gray-300': 6, 'border-gray-700': 1, 'border-gray-800': 2, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-100': 1, 'text-gray-300': 1, 'text-gray-500': 12, 'text-gray-600': 7, 'text-gray-700': 7, 'text-gray-900': 1, 'text-violet-600': 2 },
  ...
  'src/pages/DashboardPage.vue': { 'bg-gray-900': 3, 'bg-violet-600': 1, 'bg-violet-700': 1, 'border-gray-200': 3, 'border-gray-300': 3, 'border-gray-800': 3, 'border-violet-300': 1, 'border-violet-700': 1, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-100': 1, 'text-gray-500': 9, 'text-gray-900': 1, 'text-violet-600': 3 },
  'src/pages/DlqPage.vue': { 'bg-gray-50': 2, 'bg-gray-900': 1, 'bg-gray-950': 2, 'border-gray-200': 1, 'border-gray-300': 4, 'border-gray-700': 2, 'border-gray-800': 1, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-300': 1, 'text-gray-500': 8, 'text-gray-600': 3, 'text-gray-700': 1, 'text-violet-600': 4 },
  ...
  'src/pages/ForgotPasswordPage.vue': { 'bg-gray-50': 1, 'bg-gray-800': 1, 'bg-gray-900': 1, 'bg-gray-950': 1, 'bg-violet-600': 1, 'bg-violet-700': 1, 'border-gray-200': 1, 'border-gray-300': 1, 'border-gray-700': 1, 'border-gray-800': 1, 'text-gray-100': 1, 'text-gray-300': 1, 'text-gray-400': 1, 'text-gray-600': 1, 'text-gray-700': 1, 'text-gray-900': 1, 'text-violet-600': 1 },
  'src/pages/LoginPage.vue': { 'bg-gray-50': 1, 'bg-gray-800': 2, 'bg-gray-900': 1, 'bg-gray-950': 1, 'bg-violet-600': 1, 'bg-violet-700': 1, 'border-gray-200': 1, 'border-gray-300': 2, 'border-gray-700': 2, 'border-gray-800': 1, 'text-gray-100': 1, 'text-gray-300': 2, 'text-gray-400': 1, 'text-gray-600': 1, 'text-gray-700': 2, 'text-gray-900': 1, 'text-violet-600': 1 },
  ...
  'src/pages/PipelineDetailPage.vue': { 'bg-gray-50': 1, 'bg-gray-900': 2, 'bg-gray-950': 1, 'border-gray-200': 2, 'border-gray-800': 2, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-500': 10, 'text-violet-600': 3 },
  'src/pages/PipelineListPage.vue': { 'bg-gray-50': 1, 'bg-gray-900': 1, 'bg-gray-950': 1, 'border-gray-200': 2, 'border-gray-300': 2, 'border-gray-800': 2, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-500': 11, 'text-gray-600': 2, 'text-violet-600': 1 },
  'src/pages/PlatformHealthPage.vue': { 'bg-gray-900': 2, 'border-gray-200': 2, 'border-gray-800': 2, 'text-gray-500': 16 },
  'src/pages/ResetPasswordPage.vue': { 'bg-gray-50': 1, 'bg-gray-800': 4, 'bg-gray-900': 1, 'bg-gray-950': 1, 'bg-violet-600': 1, 'bg-violet-700': 1, 'border-gray-200': 1, 'border-gray-300': 4, 'border-gray-700': 4, 'border-gray-800': 1, 'text-gray-100': 1, 'text-gray-300': 4, 'text-gray-400': 1, 'text-gray-600': 1, 'text-gray-700': 4, 'text-gray-900': 1, 'text-violet-600': 1 },
  'src/pages/RunDetailPage.vue': { 'bg-gray-50': 4, 'bg-gray-900': 2, 'bg-gray-950': 3, 'bg-violet-600': 1, 'bg-violet-700': 1, 'border-gray-200': 2, 'border-gray-300': 2, 'border-gray-800': 2, 'text-gray-500': 21, 'text-violet-600': 2 },
  'src/pages/RunListPage.vue': { 'bg-gray-50': 1, 'bg-gray-900': 1, 'bg-gray-950': 1, 'border-gray-200': 1, 'border-gray-300': 2, 'border-gray-800': 1, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-500': 7, 'text-gray-600': 2, 'text-gray-700': 1, 'text-violet-600': 5 },
  ...
  'src/pages/TaskDetailPage.vue': { 'bg-gray-50': 6, 'bg-gray-900': 1, 'bg-violet-600': 2, 'bg-violet-700': 2, 'border-gray-200': 1, 'border-gray-300': 6, 'border-gray-800': 1, 'text-gray-500': 16, 'text-gray-700': 1, 'text-violet-600': 1 },
  'src/pages/TaskListPage.vue': { 'bg-gray-100': 1, 'bg-gray-50': 1, 'bg-gray-800': 1, 'bg-gray-900': 1, 'bg-gray-950': 6, 'bg-violet-50': 3, 'bg-violet-600': 3, 'bg-violet-700': 3, 'bg-violet-950': 3, 'border-gray-200': 1, 'border-gray-300': 6, 'border-gray-700': 4, 'border-gray-800': 1, 'border-violet-200': 1, 'border-violet-300': 1, 'border-violet-800': 1, 'border-violet-900': 1, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-300': 5, 'text-gray-500': 12, 'text-gray-600': 7, 'text-gray-700': 4, 'text-violet-100': 1, 'text-violet-200': 1, 'text-violet-300': 1, 'text-violet-600': 3, 'text-violet-700': 2, 'text-violet-900': 1 },

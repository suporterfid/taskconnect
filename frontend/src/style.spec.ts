...
const legacyAllowlist: Record<string, Record<string, number>> = {
  ...
  'src/pages/TaskListPage.vue': { 'bg-gray-50': 1, 'bg-gray-900': 1, 'bg-gray-950': 6, 'bg-violet-50': 2, 'bg-violet-600': 3, 'bg-violet-700': 3, 'bg-violet-950': 2, 'border-gray-200': 1, 'border-gray-300': 6, 'border-gray-700': 4, 'border-gray-800': 1, 'border-violet-200': 1, 'border-violet-300': 1, 'border-violet-800': 1, 'border-violet-900': 1, 'divide-gray-200': 2, 'divide-gray-800': 2, 'text-gray-300': 4, 'text-gray-500': 12, 'text-gray-600': 6, 'text-gray-700': 4, 'text-violet-100': 1, 'text-violet-200': 1, 'text-violet-600': 3, 'text-violet-700': 1, 'text-violet-900': 1 },
